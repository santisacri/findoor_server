...
import { ownerMiddleware } from "../../container/middlewares.container";
...
export class PropertyRoutes {
    ...
    static get routes(): Router {
        ...
        // subroutes
        router.post('/:propertyId/photos', [authMiddleware, ownerMiddleware, uploadMiddleware.array('photos', 10)], photoController.uploadPhotos)
        router.delete('/:propertyId/photos/:photoId', [authMiddleware, ownerMiddleware], photoController.deletePhoto)
